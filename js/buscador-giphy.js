    ...
    const giphy = await fetch(`https://api.giphy.com/v1/gifs/search?api_key=M2imEf1Dl7VF5mk2PciIWnuNhYZUVRwY&q=${keyword}&limit=25&offset=0&rating=g&lang=en`)
        ...
        .then(data => {
            ...
            function downloaderBuscar() {
                ...
                fetch(imagenBuscada0)
                    ...
                    .then(function (myBlob) {
                        ...
                        gif.innerHTML = `<img class="img-buscar" src="${data.data['0']['images']['original']['url']}" alt="cargando..." width="156" height="120" style="margin-top: 25px; margin-right: 5px;" />
            <div class="enlaces-img">
                ...
                <a href="max.html?${keyword}%${dato}"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a>
            </div>`
            ...
            function downloaderBuscar2() {
                ...
                fetch(imagenBuscada2)
                    ...
                    .then(function (myBlob) {
                        ...
                        gif2.innerHTML = `<img class="img-buscar" src="${data.data['2']['images']['original']['url']}" alt="cargando..." width="156" height="120" style="margin-top: 25px; margin-right: 5px; " />
            <div class="enlaces-img">
                <img class="icons img-fav" src="./img/icon-fav.svg" alt="">
            ...
            function downloaderBuscar4() {
                ...
                fetch(imagenBuscada4)
                    ...
                    .then(function (myBlob) {
                        ...
                        gif4.innerHTML = `<img class="img-buscar" src="${data.data['4']['images']['original']['url']}" alt="cargando..." width="156" height="120" style="margin-top: 25px; margin-right: 5px; " />
            <div class="enlaces-img">
                <img class="icons img-fav" src="./img/icon-fav.svg" alt="">
            ...
            function downloaderBuscar6() {
                ...
                fetch(imagenBuscada6)
                    ...
                    .then(function (myBlob) {
                        ...
                        gif6.innerHTML = `<img class="img-buscar" src="${data.data['6']['images']['original']['url']}" alt="cargando..." width="156" height="120" style="margin-top: 25px; margin-right: 5px; " />
            <div class="enlaces-img">
                <img class="icons img-fav" src="./img/icon-fav.svg" alt="">
            ...
            function downloaderBuscar8() {
                ...
                fetch(imagenBuscada8)
                    ...
                    .then(function (myBlob) {
                        ...
                        gif8.innerHTML = `<img class="img-buscar" src="${data.data['8']['images']['original']['url']}" alt="cargando..." width="156" height="120" style="margin-top: 25px ; margin-right: 5px; " />
            <div class="enlaces-img">
                <img class="icons img-fav" src="./img/icon-fav.svg" alt="">
            ...
            function downloaderBuscar10() {
                ...
                fetch(imagenBuscada10)
                    ...
                    .then(function (myBlob) {
                        ...
                        gif10.innerHTML = `<img class="img-buscar" src="${data.data['10']['images']['original']['url']}" alt="cargando..." width="156" height="120" style="margin-top: 25px ; margin-right: 5px; " />
            <div class="enlaces-img">
                <img class="icons img-fav" src="./img/icon-fav.svg" alt="">
    ...
    const giphy = fetch(`https://api.giphy.com/v1/gifs/search?api_key=M2imEf1Dl7VF5mk2PciIWnuNhYZUVRwY&q=${keyword}&limit=12&offset=${offset}&rating=g&lang=en`)
        ...
        .then(data => {
            ...
            <div class="enlaces-img">
                <img class="icons img-fav" src="./img/icon-fav.svg" alt="">
                <a href="${objectURLimg}" download="img.gif"><img class="icons img-dow" src="./img/icon-download.svg" alt=""></a>
                <a href="max.html?${keyword}?${dato}%${oset}"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a>
            </div>`
