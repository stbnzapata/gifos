...
async function Traer() {
    ...
    await fetch('https://api.giphy.com/v1/gifs/trending?api_key=M2imEf1Dl7VF5mk2PciIWnuNhYZUVRwY&limit=25&rating=g')
        ...
        .then(data => {
            ...
            <a href="max.html?0" onClick=""><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?1" onClick=""><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?2"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?3"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?4"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?5"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?6"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?7"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?8"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?9"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?10"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?11"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?12"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?13"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?14"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?15"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?16"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?17"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
            ...
            <a href="max.html?18"><img class="icons img-max" src="./img/icon-max-normal.svg" alt=""></a></div>`
